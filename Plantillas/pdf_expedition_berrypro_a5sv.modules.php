 ...
 */
class pdf_expedition_berrypro_a5sv extends ModelePdfExpedition
{
	...
	function __construct($db=0)
	{
		...
		$this->db = $db;
		$this->name = "BerryPro-A5-SinValorar";
		$this->description = "BerryPro A5 Sin valorar";
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		if ($this->emetteur->logo)
		{
			if (is_readable($logo))
			{
			    ...
			    $pdf->Image($logo,10, 5, 0, $height * 0.7);	// width=0 (auto)
			}
			else
			{
