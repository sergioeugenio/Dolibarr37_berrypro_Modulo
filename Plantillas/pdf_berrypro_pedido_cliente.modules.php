 ...
 */
class pdf_berrypro_pedido_cliente extends ModelePDFCommandes
{
    var $db;
    var $name;
    var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "berrypro_pedido_cliente";
		//$this->description = $langs->trans('PDFEinsteinDescription');
		$this->description = "Plantilla de Pedido de cliente";
	...
	function _tableau_tot(&$pdf, $object, $deja_regle, $posy, $outputlangs)
	{
		...
		$pdf->MultiCell($col2x-$col1x, $tab2_hl, $outputlangs->transnoentities("TotalHTShort"), 0, 'L', 1);
