 ...
 */
class pdf_berrypro_trans_mont_inc extends ModelePDFPropales
{
	var $db;
	var $name;
	var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "Transporte Incluido y Montaje Incluido";
		$this->description = "BerryPro - Transporte Incluido - Montaje Incluido";
		...
		if ($conf->propal->dir_output)
		{
			...
			if (file_exists($dir))
			{
				...
				*/
				...
				//$pdf->AliasNbPages(); Comentado por error en la actualización
