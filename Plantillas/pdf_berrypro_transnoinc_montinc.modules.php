 ...
 */
class pdf_berrypro_transnoinc_montinc extends ModelePDFPropales
{
	var $db;
	var $name;
	var $description;
	...
	function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "Transporte No Incluido y Montaje Incluido";
		$this->description = "BerryPro - Transporte NO Incluido - Montaje Incluido";
