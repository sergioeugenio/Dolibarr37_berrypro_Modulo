...
/**
 *	\file       htdocs/custom/berrypro/admin/berrypro.php
 *Cambiar grupo	\ingroup    cashdesk
...
print '<br>';
$head = berryproadmin_prepare_head(); //Vigilar

dol_fiche_head($head, 'configuration', $langs->trans("BerryPro"), 0, 'bill');
