...
/**
*  \file       berrypro/liste.php
 *  \filebase       htdocs/product/liste.php
 *  \ingroup    produit
 *  \brief      Muestra el listado de Productos con precios de venta. Se puede
 *							obviar ya que en las actualizaciones vien por defecto esta vista.
 */
...
else
{
    ...
    $texte.= "&nbsp; &nbsp; &nbsp; <a href='liste-copia.php'>Listado con precios de venta</a>";
    ...
    if ($resql)
    {
    	...
    	else
    	{
    		...
    		while ($i < min($num,$limit))
    		{
    			...
    			// Label
    			print '<td>'.dol_trunc($objp->label,120).'</td>';//se modifica los caracteres a mostrar de 40 a 120
