...
/**
 *	    \file       htdocs/custom/berrypro/informe_iva.php
 *	    \filebase       htdocs/compta/tva/quadri_detail.php
 *      \ingroup    tax
...
require_once DOL_DOCUMENT_ROOT.'/custom/berrypro/lib/tax.lib.php'; //Modificado también
	...
	foreach(array_keys($x_coll) as $my_coll_rate)
	{
		...
		foreach($x_coll[$my_coll_rate]['facid'] as $id=>$dummy)
		{
			...
			$x_both[$my_coll_rate]['coll']['detail'][] = array(
				...
				'nom'       =>$x_coll[$my_coll_rate]['nom'][$id],
...
//		$firephp->fb($id_dummy, "id_dummy");
	...
	foreach(array_keys($x_paye) as $my_paye_rate){
		...
		foreach($x_paye[$my_paye_rate]['facid'] as $id=>$dummy)
		{
			...
			$x_both[$my_paye_rate]['paye']['detail'][] = array(
				...
				'nom'       =>$x_paye[$my_paye_rate]['nom'][$id],
	...
	print '<td align="left">'.$langs->trans("Customers").'</td>';
	...
	print '<td align="left"> Proveedores </td>';
