...
/**
 *	\file       htdocs/custom/berrypro/core/boxes/box_factures_imp2.php
...
class box_factures_imp extends ModeleBoxes
{
	...
	var $boxlabel="Ultimas Facturas de Clientes Ptes de Pago";
	...
	function loadBox($max=5)
	{
		...
		$this->info_box_head = array('text' => $langs->trans("BoxTitleOldestUnpaidCustomerBills",$max)." - Ver M&aacute;s...");
