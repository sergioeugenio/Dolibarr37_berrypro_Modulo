...
/**
 *	\file       htdocs/custom/berrypro/core/boxes/box_factures_impag.php
 *	\filebase   htdocs/core/boxes/box_factures_imp.php
 *	\ingroup    factures
 *	\brief      Módulo para generar el Panel con Listado de facturas de Clientes Impagadas
 */
 ...
 */
class box_factures_impag extends ModeleBoxes
{
	var $boxcode="oldestunpaidcustomerbills";
	var $boximg="object_bill";
	var $boxlabel="BP-Últimas Facturas de Clientes Ptes de Cobro"; //Título en la casilla de selección desplegable
